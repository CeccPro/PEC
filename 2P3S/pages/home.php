    ...
    <div class="container">
        <div class="row gx-5 align-items-center">
            <div class="col-lg-6 d-flex flex-column gap-3">
                ...
                <p class="lead text-muted-dark mb-4"><?php echo $translations['hero_subtitle']; ?></p>
                ...
                <div class="d-flex gap-3 mt-4">
                    <div class="stat px-4 py-3 rounded card-dark">
                        <small class="d-block text-muted-dark"><?php echo $translations['stat_trees_planted_label'] ?? 'Árboles plantados'; ?></small>
                        <strong class="h4 mb-0 text-light"><?php echo $translations['stat_trees_planted_value'] ?? '1200'; ?></strong>
                    </div>
                    <div class="stat px-4 py-3 rounded card-dark">
                        <small class="d-block text-muted-dark"><?php echo $translations['stat_areas_restored_label'] ?? 'Áreas restauradas'; ?></small>
        ...
        <section id="learn-more" class="py-5">
            <div class="row gy-4 align-items-center">
                <div class="col-lg-7">
                    ...
                    <p class="lead text-muted-dark"><?php echo $translations['what_is_content']; ?></p>
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="info-box p-3 rounded card-dark">
                                <h6 class="fw-bold text-light mb-1"><?php echo $translations['goal_absorption']; ?></h6>
                                <small class="text-muted-dark"><?php echo $translations['goal_absorption_desc']; ?></small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-box p-3 rounded card-dark">
                                <h6 class="fw-bold text-light mb-1"><?php echo $translations['goal_oxygen']; ?></h6>
                                <small class="text-muted-dark"><?php echo $translations['goal_oxygen_desc']; ?></small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-box p-3 rounded card-dark">
                                <h6 class="fw-bold text-light mb-1"><?php echo $translations['goal_habitat']; ?></h6>
                                <small class="text-muted-dark"><?php echo $translations['goal_habitat_desc']; ?></small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="card card-dark h-100 text-center p-3 rounded">
                        ...
                        <li><p class="text-muted-dark small"><?php echo $translations['climate_desc']; ?></p></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card card-dark h-100 text-center p-3 rounded">
                        ...
                        <li><p class="text-muted-dark small"><?php echo $translations['biodiversity_desc']; ?></p></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card card-dark h-100 text-center p-3 rounded">
                        ...
                        <li><p class="text-muted-dark small"><?php echo $translations['water_desc']; ?></p></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card card-dark h-100 text-center p-3 rounded">
                        ...
                        <li><p class="text-muted-dark small"><?php echo $translations['economic_desc']; ?></p></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="py-5 text-center">
            <div class="card card-dark p-4 rounded shadow-sm">
                ...
                <p class="text-muted-dark mb-4"><?php echo $translations['cta_text']; ?></p>
                <a href="index.php?page=how-to" class="btn btn-dark-accent btn-lg">
