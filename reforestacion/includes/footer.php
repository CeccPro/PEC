            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="pages/matematicas.php" class="text-muted text-decoration-none">
                                <?php echo $translations['subject_matematicas_title']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/humanidades.php" class="text-muted text-decoration-none">
                                <?php echo $translations['subject_humanidades_title']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/programacion.php" class="text-muted text-decoration-none">
                                <?php echo $translations['subject_programacion_title']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/ecosistemas.php" class="text-muted text-decoration-none">
                                <?php echo $translations['subject_ecosistemas_title']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/comunicacion.php" class="text-muted text-decoration-none">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="pages/about.php" class="text-muted text-decoration-none">
                                <?php echo $translations['nav_about']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/calculator.php" class="text-muted text-decoration-none">
                                <?php echo $translations['nav_calculator']; ?>
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="pages/cbta_project.php" class="text-muted text-decoration-none">
