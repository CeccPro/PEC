        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($currentPage ?? '') == 'cbta_project' ? 'active' : ''; ?>" href="cbta_project.php">
